...
// Del 2 - Copied steps 1-3 from bubble chart starter code. 
...
/// Del - 3 refractored from gauge starter code
///  Updates needed in Steps 1-3. Filter, variable and converting washing frequency to a floating point number. 
    var metadata = data.metadata;
    var resultArray = metadata.filter(sampleObj => sampleObj.id == sample);
    var result = resultArray[0];
